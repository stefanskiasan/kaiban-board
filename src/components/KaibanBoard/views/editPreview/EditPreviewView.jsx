    ...
    return (
        <div className="relative flex flex-col mt-6 px-6">
            ...
            <div className="fixed bottom-0 bg-slate-900 pb-8 pt-4 md:pb-4 pr-4 md:w-3/6">
                ...
                <span className="text-xs font-normal text-slate-400">Everything you do here is local. We don’t access your API keys, data, or code. Have fun and build with confidence!</span>
            </div>
            {/* --- PRIVACY --- */}
        </div>
    );
