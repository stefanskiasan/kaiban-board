        ...
        <div className={`${uiSettings.isChatbotFloating ? 'kb-fixed kb-bottom-4 kb-right-4' : 'kb-absolute kb-bottom-2 kb-right-2'} kb-z-[9999] ${isChatBotOpen ? 'kb-inset-0' : ''}`}>
            {!isChatBotOpen && uiSettings.isChatbotFloating && (
                <Button
                    ...
                    className="kb-bg-indigo-500 kb-text-white kb-rounded-full kb-p-4 kb-shadow-xl kb-shadow-indigo-500/50 kb-transition-all kb-duration-300 data-[focus]:kb-outline-none data-[focus]:kb-ring-2 data-[focus]:kb-ring-offset-2 data-[focus]:kb-ring-white data-[hover]:kb-bg-indigo-600 data-[hover]:kb-shadow-xl data-[hover]:kb-scale-110"
                >
