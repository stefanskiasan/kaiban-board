...
const ChatBot = () => {
  ...
  const { uiSettings, isChatBotOpen, setChatBotOpenAction } =
              ...
              for (let word of newContent) {
                ...
                setMessages(prevMessages => {
                  ...
                  newMessages[newMessages.length - 1] = {
                    ...
                    content:
                      accumulatedContent +
                      '<span class="kb-ml-2 kb-inline-block kb-w-2 kb-h-2 kb-bg-slate-400 kb-rounded-full"></span>',
                  };
                  return newMessages;
                });
        ...
        >
          <div className="kb-bg-indigo-500 kb-p-4 kb-flex kb-justify-between kb-items-center kb-border-b kb-border-slate-900">
            <div className="kb-flex kb-items-center kb-gap-2 kb-text-white">
              <img
                className="kb-w-7 kb-h-7 kb-rounded-full kb-ring-2 kb-ring-indigo-400 kb-bg-slate-800"
                src="https://robohash.org/Assistan"
                alt=""
              />
              <h3 className="kb-font-bold kb-text-lg kb-text-white kb-cursor-default">
                Kai
              </h3>
            </div>
            <div className="kb-flex kb-items-center kb-space-x-2">
              <Button
                ...
                className="kb-text-white data-[hover]:kb-text-indigo-200 data-[focus]:kb-outline-none kb-hidden md:kb-block"
              >
                {isMaximized ? (
                  <ArrowsPointingInIcon className="kb-h-5 kb-w-5" />
                ) : (
                  <ArrowsPointingOutIcon className="kb-h-5 kb-w-5" />
                )}
              </Button>
              <Button
                onClick={() => setChatBotOpenAction(false)}
                className="kb-text-white data-[hover]:kb-text-indigo-200 data-[focus]:kb-outline-none"
              >
                ...
                <div className="kb-flex kb-flex-wrap kb-gap-2 kb-justify-center">
                  {initialSuggestions.map((suggestion, index) => {
                    ...
                    return (
                      ...
                      >
                        <IconComponent
                          className={`kb-h-4 kb-w-4 ${suggestion.iconColor}`}
                        />
                        {suggestion.text}
                      </Button>
                    );
