...
const finalizeInspectionAndApprovalTask = new Task({
  ...
  description: \`Finalize inspection and approval of the event setup. Please use markdown format for the output.\`,
  expectedOutput: \`Inspection report. Any notes on final adjustments or feedback. Always use markdown format for the output.\`,
